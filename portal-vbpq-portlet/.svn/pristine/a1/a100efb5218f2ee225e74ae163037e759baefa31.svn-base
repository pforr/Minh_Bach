...
public class AttachFileLocalServiceClp implements AttachFileLocalService {
	...
	public com.dtt.portal.dao.vbpq.model.AttachFile addAttachFile(
		...
		return (com.dtt.portal.dao.vbpq.model.AttachFile)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.dtt.portal.dao.vbpq.model.AttachFile> getAttachFiles(
		...
		return (java.util.List<com.dtt.portal.dao.vbpq.model.AttachFile>)ClpSerializer.translateOutput(returnObj);
	}
