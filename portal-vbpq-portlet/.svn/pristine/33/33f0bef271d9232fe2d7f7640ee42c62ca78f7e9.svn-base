...
public class LinhVucVanBanFinderUtil {
	...
	public static java.util.List<com.dtt.portal.dao.vbpq.model.LinhVucVanBan> find(
	...
	public static LinhVucVanBanFinder getFinder() {
		if (_finder == null) {
			_finder = (LinhVucVanBanFinder)PortletBeanLocatorUtil.locate(com.dtt.portal.dao.vbpq.service.ClpSerializer.getServletContextName(),
